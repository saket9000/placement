function RGBColor(m) {
    ...
    this.getHelpXML = function() {
        for (var b = [], c = 0; c < d.length; c++)
            for (var k = d[c].example, h = 0; h < k.length; h++) b[b.length] = k[h];
        ...
        for (c = 0; c < b.length; c++) try {
            ...
            var q = document.createTextNode(" " + b[c] + " -> " + o.toRGB() + " -> " + o.toHex());
            l.appendChild(n);
            l.appendChild(q);
            k.appendChild(l)
        } catch (p) {}
    ...
    function m() {
        ...
        a.Font = new function() {
            ...
            this.Parse = function(d) {
                for (var b = {}, d = a.trim(a.compressSpaces(d || "")).split(" "), k = !1, e = !1, f = !1, g = !1, h = "", j = 0; j < d.length; j++)
                    if (!e && c.Styles.indexOf(d[j]) != -1) {
            ...
            this.renderChildren = function(d) {
                ...
                if (b != null) {
                    ...
                    if (this.style("marker-mid").Definition.isUrl())
                        for (var c = this.style("marker-mid").Definition.getDefinition(), e = 1; e < b.length - 1; e++) c.render(d, b[e][0], b[e][1]);
                    ...
                    case "A":
                        for (; !b.isCommandOrEnd();) {
                            var g = b.current,
                                ...
                                q = Math.pow(n.x, 2) / Math.pow(j, 2) + Math.pow(n.y, 2) / Math.pow(l, 2);
                            ...
                            isNaN(o) && (o = 0);
                            var p = new a.Point(o * j * n.y / l, o * -l * n.x / j),
                                g = new a.Point((g.x + e.x) / 2 + Math.cos(f) *
                                    p.x - Math.sin(f) * p.y, (g.y + e.y) / 2 + Math.sin(f) * p.x + Math.cos(f) * p.y),
                                m = function(b, a) {
                                ...
                                o = s([1, 0], [(n.x - p.x) / j, (n.y - p.y) / l]),
                                q = [(n.x - p.x) / j, (n.y - p.y) / l],
                                p = [(-n.x - p.x) / j, (-n.y - p.y) / l],
                                n = s(q, p);
        ...
        a.Element.linearGradient = function(c) {
            ...
            this.getGradient = function(a, b) {
                var c = b.getBoundingBox(),
                    ...
                    g = this.gradientUnits == "objectBoundingBox" ?
                    c.x() + c.width() * this.attribute("x2").numValue() : this.attribute("x2").Length.toPixels("x"),
        ...
        a.Element.radialGradient = function(c) {
            ...
            this.getGradient = function(a, b) {
                var c = b.getBoundingBox(),
                    ...
                    c.x() + c.width() * this.attribute("cx").numValue() : this.attribute("cx").Length.toPixels("x"),
        ...
        a.Element.font = function(c) {
            ...
            for (c = 0; c < this.children.length; c++) {
                ...
                else if (d.type == "missing-glyph") this.missingGlyph =
                    d;
            ...
            this.renderChildren =
                function(b) {
                    for (var a = this.style("text-anchor").valueOrDefault("start"), c = this.attribute("x").Length.toPixels("x"), d = this.attribute("y").Length.toPixels("y"), h = 0; h < this.children.length; h++) {
                        ...
                        c = j.measureText ? j.measureText(b) : 0;
        ...
        a.Element.symbol = function(c) {
            ...
            this.setContext = function(c) {
                ...
                if (this.attribute("viewBox").hasValue()) {
                    var b =
                        a.ToNumberArray(this.attribute("viewBox").value),
                        k = b[0],
                        e = b[1];
                    width = b[2];
                    height = b[3];
        ...
        a.Element.filter = function(c) {
            ...
            this.apply = function(a, b) {
                ...
                var g =
                    ...
                    h = this.attribute("height").Length.toPixels("y");
...
(function(m) {
    ...
    k(d.prototype, {
        ...
        configure: function(a) {
            ...
            f(a, "tooltipRefresh", function(d) {
                var e = a.container,
                    f = e.offsetLeft,
                    e = e.offsetTop,
                    g;
                h.innerHTML = d.text;
                g = a.tooltip.getPosition(h.offsetWidth, h.offsetHeight, {
                    plotX: d.x,
                    plotY: d.y
                });
                c(h, {
        ...
        color: function(a, c, d) {
            ...
            return b.prototype.color.call(this, a, c, d)
        },
        draw: function() {
            a.canvg(this.canvas, this.hiddenSvg.innerHTML)
        }
    })
})(Highcharts);